(function(){
  ...
  const section=file==='index.html'?'index':file.includes('inventaire')||file==='pc.html'||file.includes('vente')?'inventaire':file.includes('propos')?'apropos':file.includes('contact')?'contact':'services';
  ...
  const mobileLinks=`<a${active('index')} href="index.html">Accueil</a><a${active('services')} href="services.html">Services</a><a${active('inventaire')} href="inventaire.html">Inventaire</a><a${active('apropos')} href="a-propos.html">À propos</a><a${active('contact')} href="contact.html">Contact</a>`;
